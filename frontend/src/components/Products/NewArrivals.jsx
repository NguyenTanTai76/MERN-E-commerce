...
const NewArrivals = () => {
  ...
  const handleMouseMove = (e) => {
    ...
    updateScrollButtons(); // gọi liên tục để cập nhật
  };

  // Hàm xử lý khi kết thúc kéo chuột
  const handleMouseUpOrLeave = () => {
    setIsDragging(false);
    updateScrollButtons(); // gọi thêm lần cuối sau khi thả chuột
  };
  ...
  // Dùng useEffect để đăng ký sự kiện cuộn
  useEffect(() => {
    const container = scrollRef.current;
    if (!container) return;
